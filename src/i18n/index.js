...
const translations = {
  ru: {
    ...
    disclaimer: 'Tezcheck может ошибаться. Проверяйте важную информацию.',
  ...
  kz: {
    ...
    disclaimer: 'Tezcheck қателесуі мүмкін. Маңызды ақпаратты тексеріңіз.',
  ...
  en: {
    ...
    disclaimer: 'Tezcheck can make mistakes. Verify important information.',
